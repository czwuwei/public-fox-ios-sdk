...
Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "7.0"
  s.source           = {:http => "https://github.com/cyber-z/public-fox-ios-sdk/releases/download/#{s.version}/FOXSDK_static_iOS_#{s.version}.zip"}
  s.vendored_frameworks = "FOXSDK_static_iOS_#{s.version}/FOXSDK.framework"
