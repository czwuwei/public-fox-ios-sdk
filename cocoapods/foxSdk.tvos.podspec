...
Pod::Spec.new do |s|
  ...
  s.platform     = :tvos, "9.0"
  s.source           = {:http => "https://github.com/cyber-z/public-fox-ios-sdk/releases/download/#{s.version}/FOXSDK_static_tvOS_#{s.version}.zip"}
  s.vendored_frameworks = "FOXSDK_static_tvOS_#{s.version}/FOXSDK.framework"
