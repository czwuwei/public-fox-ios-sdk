...
Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "8.0"
  s.source           = {:http => "https://github.com/czwuwei/public-fox-ios-sdk/releases/download/#{s.version}/CYZFox_iOS_dynamic_#{s.version}.framework.zip"}
  s.vendored_frameworks = "**/iOS/*.framework"

  s.frameworks = "Foundation", "Security", "AdSupport", "SystemConfiguration", "WebKit", "UIKit"
